...
public class EnemySpawner : MonoBehaviour
{
    ...
    {
        if (GameObject.Find("Enemy Spawn") == null)
            spawnObj = new GameObject("Enemy Spawn");
        else
            spawnObj = GameObject.Find("Enemy Spawn");
    }

    private void RemoveParent()
    {
        if (GameObject.Find("Enemy Spawn") != null)
            DestroyImmediate(GameObject.Find("Enemy Spawn"));
    }
